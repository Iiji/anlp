...
job_name=llava-mixed-v0.1-lora
...
deepspeed train_mem.py \
    ...
    --version v1 \
    --data_path ./data/trained_data_mixed_v0.1.json \
    --image_folder ./data \
...
job_name=llava-mixed-v0.01-lora
export WANDB_RUN_ID=${job_name/\//\_}
...
deepspeed train_mem.py \
    ...
    --model_name_or_path liuhaotian/llava-v1.5-7b \
    --version v1 \
    --data_path ./data/trained_data_mixed_v0.json \
    --image_folder ./data \
    --vision_tower openai/clip-vit-large-patch14-336 \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
